param (
    [string]$ApiPath = "C:\Proyecto App Movil Cuidadores Pets\Backend\PetCarePlatform\Notification\PetCare.Notification.Api"
)
...
WORKDIR /src
COPY . .
RUN dotnet restore "PetCare.Notification.Api.csproj"
...
Write-Host "`n✅ Dockerfile y launchSettings.json generados para PetCare.Notification.Api" -ForegroundColor Green