param (
    [string]$ApiPath = "C:\Proyecto App Movil Cuidadores Pets\Backend\PetCarePlatform\Review\PetCare.Review.Api"
)
...
WORKDIR /src
COPY . .
RUN dotnet restore "PetCare.Review.Api.csproj"
...
Write-Host "`n✅ Dockerfile y launchSettings.json generados para PetCare.Review.Api" -ForegroundColor Green